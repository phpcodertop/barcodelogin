...
if(isset($_POST['add'])){
    ...
    mysql_query("SET NAMES 'utf8'");
    $query = mysql_query("INSERT INTO `student` VALUES  ('','$name','$family','$position','$city','$country','$email','$postoffice','$notes','$receivemail','$receivesms','$date')") or die("error in query");
    mysql_query("SET NAMES 'utf8'");
    $query2 = mysql_query("INSERT INTO `admin` VALUES  ('','$name','$password','0')") or die("error in query");
        if(isset($query)){
                ...
                $n = $r['id'];
            echo '<meta http-equiv="refresh" content="5; url=student/index.php" /> ';
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <form action="signup.php" method="post">
              ...
              <div class="form-group mb15">
                <input type="text" name="country" class="form-control" placeholder="البلد">
              </div>
              <div class="form-group mb15">
