            ...
            <nav class="cyan">
                <div class="nav-wrapper">
                    ...
                    <ul class="left">
                      ...
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img style="width: 20px; height: 20px;" src="student/images/Vanamo_Logo.png" alt="logo"></a> <span class="logo-text">Materialize</span></h1></li>
                    </ul>
